...
import { sampleWithRequiredData, sampleWithNewData } from '../table-10.test-samples';

import { Table10FormService } from './table-10-form.service';

describe('Table10 Form Service', () => {
  let service: Table10FormService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(Table10FormService);
  });

  describe('Service methods', () => {
    describe('createTable10FormGroup', () => {
      it('should create a new form with FormControl', () => {
        const formGroup = service.createTable10FormGroup();
      ...
      it('passing ITable10 should create a new form with FormGroup', () => {
        const formGroup = service.createTable10FormGroup(sampleWithRequiredData);
    ...
    describe('getTable10', () => {
      it('should return NewTable10 for default Table10 initial value', () => {
        const formGroup = service.createTable10FormGroup(sampleWithNewData);

        const table10 = service.getTable10(formGroup) as any;

        expect(table10).toMatchObject(sampleWithNewData);
      });

      it('should return NewTable10 for empty Table10 initial value', () => {
        const formGroup = service.createTable10FormGroup();

        const table10 = service.getTable10(formGroup) as any;

        expect(table10).toMatchObject({});
      });

      it('should return ITable10', () => {
        const formGroup = service.createTable10FormGroup(sampleWithRequiredData);

        const table10 = service.getTable10(formGroup) as any;

        expect(table10).toMatchObject(sampleWithRequiredData);
      });
    });

    describe('resetForm', () => {
      it('passing ITable10 should not enable id FormControl', () => {
        const formGroup = service.createTable10FormGroup();
      ...
      it('passing NewTable10 should disable id FormControl', () => {
        const formGroup = service.createTable10FormGroup(sampleWithRequiredData);
        expect(formGroup.controls.id.disabled).toBe(true);
