...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../table-10.test-samples';

import { Table10Service, RestTable10 } from './table-10.service';

const requireRestSample: RestTable10 = {
...
describe('Table10 Service', () => {
  ...
  let expectedResult: ITable10 | ITable10[] | boolean | null;
  ...
  beforeEach(() => {
    ...
    expectedResult = null;
    service = TestBed.inject(Table10Service);
  ...
  describe('Service methods', () => {
    ...
    it('should create a Table10', () => {
      const table10 = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(table10).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Table10', () => {
      const table10 = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(table10).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should partial update a Table10', () => {
    ...
    it('should return a list of Table10', () => {
      const returnedFromService = { ...requireRestSample };
    ...
    describe('addTable10ToCollectionIfMissing', () => {
      it('should add a Table10 to an empty array', () => {
        const table10: ITable10 = sampleWithRequiredData;
        expectedResult = service.addTable10ToCollectionIfMissing([], table10);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table10);
      });

      it('should not add a Table10 to an array that contains it', () => {
        const table10: ITable10 = sampleWithRequiredData;
        const table10Collection: ITable10[] = [
          {
            ...table10,
          },
          sampleWithPartialData,
        ];
        expectedResult = service.addTable10ToCollectionIfMissing(table10Collection, table10);
        expect(expectedResult).toHaveLength(2);
      });

      it("should add a Table10 to an array that doesn't contain it", () => {
        const table10: ITable10 = sampleWithRequiredData;
        const table10Collection: ITable10[] = [sampleWithPartialData];
        expectedResult = service.addTable10ToCollectionIfMissing(table10Collection, table10);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table10);
      });

      it('should add only unique Table10 to an array', () => {
        const table10Array: ITable10[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const table10Collection: ITable10[] = [sampleWithRequiredData];
        expectedResult = service.addTable10ToCollectionIfMissing(table10Collection, ...table10Array);
        expect(expectedResult).toHaveLength(3);
      });

      it('should accept varargs', () => {
        const table10: ITable10 = sampleWithRequiredData;
        const table102: ITable10 = sampleWithPartialData;
        expectedResult = service.addTable10ToCollectionIfMissing([], table10, table102);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table10);
        expect(expectedResult).toContain(table102);
      });

      it('should accept null and undefined values', () => {
        const table10: ITable10 = sampleWithRequiredData;
        expectedResult = service.addTable10ToCollectionIfMissing([], null, table10, undefined);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table10);
      });

      it('should return initial array if no Table10 is added', () => {
        const table10Collection: ITable10[] = [sampleWithRequiredData];
        expectedResult = service.addTable10ToCollectionIfMissing(table10Collection, undefined, null);
        expect(expectedResult).toEqual(table10Collection);
      });
    });

    describe('compareTable10', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareTable10(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareTable10(entity1, entity2);
        const compareResult2 = service.compareTable10(entity2, entity1);
