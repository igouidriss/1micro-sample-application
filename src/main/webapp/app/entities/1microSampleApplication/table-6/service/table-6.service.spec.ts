...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../table-6.test-samples';

import { Table6Service, RestTable6 } from './table-6.service';

const requireRestSample: RestTable6 = {
...
describe('Table6 Service', () => {
  ...
  let expectedResult: ITable6 | ITable6[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    it('should create a Table6', () => {
      const table6 = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(table6).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Table6', () => {
      const table6 = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(table6).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should partial update a Table6', () => {
    ...
    it('should return a list of Table6', () => {
      const returnedFromService = { ...requireRestSample };
    ...
    describe('addTable6ToCollectionIfMissing', () => {
      it('should add a Table6 to an empty array', () => {
        const table6: ITable6 = sampleWithRequiredData;
        expectedResult = service.addTable6ToCollectionIfMissing([], table6);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table6);
      });

      it('should not add a Table6 to an array that contains it', () => {
        const table6: ITable6 = sampleWithRequiredData;
        const table6Collection: ITable6[] = [
          {
            ...table6,
          },
          sampleWithPartialData,
        ];
        expectedResult = service.addTable6ToCollectionIfMissing(table6Collection, table6);
        expect(expectedResult).toHaveLength(2);
      });

      it("should add a Table6 to an array that doesn't contain it", () => {
        const table6: ITable6 = sampleWithRequiredData;
        const table6Collection: ITable6[] = [sampleWithPartialData];
        expectedResult = service.addTable6ToCollectionIfMissing(table6Collection, table6);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table6);
      });

      it('should add only unique Table6 to an array', () => {
        const table6Array: ITable6[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const table6Collection: ITable6[] = [sampleWithRequiredData];
        expectedResult = service.addTable6ToCollectionIfMissing(table6Collection, ...table6Array);
        expect(expectedResult).toHaveLength(3);
      });

      it('should accept varargs', () => {
        const table6: ITable6 = sampleWithRequiredData;
        const table62: ITable6 = sampleWithPartialData;
        expectedResult = service.addTable6ToCollectionIfMissing([], table6, table62);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table6);
        expect(expectedResult).toContain(table62);
      });

      it('should accept null and undefined values', () => {
        const table6: ITable6 = sampleWithRequiredData;
        expectedResult = service.addTable6ToCollectionIfMissing([], null, table6, undefined);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table6);
      });

      it('should return initial array if no Table6 is added', () => {
        const table6Collection: ITable6[] = [sampleWithRequiredData];
        expectedResult = service.addTable6ToCollectionIfMissing(table6Collection, undefined, null);
        expect(expectedResult).toEqual(table6Collection);
      });
    });

    describe('compareTable6', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareTable6(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareTable6(entity1, entity2);
        const compareResult2 = service.compareTable6(entity2, entity1);
