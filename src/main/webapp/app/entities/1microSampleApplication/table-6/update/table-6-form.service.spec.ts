...
import { sampleWithRequiredData, sampleWithNewData } from '../table-6.test-samples';

import { Table6FormService } from './table-6-form.service';

describe('Table6 Form Service', () => {
  let service: Table6FormService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(Table6FormService);
  });

  describe('Service methods', () => {
    describe('createTable6FormGroup', () => {
      it('should create a new form with FormControl', () => {
        const formGroup = service.createTable6FormGroup();
      ...
      it('passing ITable6 should create a new form with FormGroup', () => {
        const formGroup = service.createTable6FormGroup(sampleWithRequiredData);
    ...
    describe('getTable6', () => {
      it('should return NewTable6 for default Table6 initial value', () => {
        const formGroup = service.createTable6FormGroup(sampleWithNewData);

        const table6 = service.getTable6(formGroup) as any;

        expect(table6).toMatchObject(sampleWithNewData);
      });

      it('should return NewTable6 for empty Table6 initial value', () => {
        const formGroup = service.createTable6FormGroup();

        const table6 = service.getTable6(formGroup) as any;

        expect(table6).toMatchObject({});
      });

      it('should return ITable6', () => {
        const formGroup = service.createTable6FormGroup(sampleWithRequiredData);

        const table6 = service.getTable6(formGroup) as any;

        expect(table6).toMatchObject(sampleWithRequiredData);
      });
    });

    describe('resetForm', () => {
      it('passing ITable6 should not enable id FormControl', () => {
        const formGroup = service.createTable6FormGroup();
      ...
      it('passing NewTable6 should disable id FormControl', () => {
        const formGroup = service.createTable6FormGroup(sampleWithRequiredData);
        expect(formGroup.controls.id.disabled).toBe(true);
