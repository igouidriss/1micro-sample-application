...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../table-8.test-samples';

import { Table8Service, RestTable8 } from './table-8.service';

const requireRestSample: RestTable8 = {
...
describe('Table8 Service', () => {
  ...
  let expectedResult: ITable8 | ITable8[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    it('should create a Table8', () => {
      const table8 = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(table8).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Table8', () => {
      const table8 = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(table8).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should partial update a Table8', () => {
    ...
    it('should return a list of Table8', () => {
      const returnedFromService = { ...requireRestSample };
    ...
    describe('addTable8ToCollectionIfMissing', () => {
      it('should add a Table8 to an empty array', () => {
        const table8: ITable8 = sampleWithRequiredData;
        expectedResult = service.addTable8ToCollectionIfMissing([], table8);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table8);
      });

      it('should not add a Table8 to an array that contains it', () => {
        const table8: ITable8 = sampleWithRequiredData;
        const table8Collection: ITable8[] = [
          {
            ...table8,
          },
          sampleWithPartialData,
        ];
        expectedResult = service.addTable8ToCollectionIfMissing(table8Collection, table8);
        expect(expectedResult).toHaveLength(2);
      });

      it("should add a Table8 to an array that doesn't contain it", () => {
        const table8: ITable8 = sampleWithRequiredData;
        const table8Collection: ITable8[] = [sampleWithPartialData];
        expectedResult = service.addTable8ToCollectionIfMissing(table8Collection, table8);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table8);
      });

      it('should add only unique Table8 to an array', () => {
        const table8Array: ITable8[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const table8Collection: ITable8[] = [sampleWithRequiredData];
        expectedResult = service.addTable8ToCollectionIfMissing(table8Collection, ...table8Array);
        expect(expectedResult).toHaveLength(3);
      });

      it('should accept varargs', () => {
        const table8: ITable8 = sampleWithRequiredData;
        const table82: ITable8 = sampleWithPartialData;
        expectedResult = service.addTable8ToCollectionIfMissing([], table8, table82);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table8);
        expect(expectedResult).toContain(table82);
      });

      it('should accept null and undefined values', () => {
        const table8: ITable8 = sampleWithRequiredData;
        expectedResult = service.addTable8ToCollectionIfMissing([], null, table8, undefined);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table8);
      });

      it('should return initial array if no Table8 is added', () => {
        const table8Collection: ITable8[] = [sampleWithRequiredData];
        expectedResult = service.addTable8ToCollectionIfMissing(table8Collection, undefined, null);
        expect(expectedResult).toEqual(table8Collection);
      });
    });

    describe('compareTable8', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareTable8(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareTable8(entity1, entity2);
        const compareResult2 = service.compareTable8(entity2, entity1);
