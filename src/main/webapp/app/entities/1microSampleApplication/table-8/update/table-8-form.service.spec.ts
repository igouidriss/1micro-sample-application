...
import { sampleWithRequiredData, sampleWithNewData } from '../table-8.test-samples';

import { Table8FormService } from './table-8-form.service';

describe('Table8 Form Service', () => {
  let service: Table8FormService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(Table8FormService);
  });

  describe('Service methods', () => {
    describe('createTable8FormGroup', () => {
      it('should create a new form with FormControl', () => {
        const formGroup = service.createTable8FormGroup();
      ...
      it('passing ITable8 should create a new form with FormGroup', () => {
        const formGroup = service.createTable8FormGroup(sampleWithRequiredData);
    ...
    describe('getTable8', () => {
      it('should return NewTable8 for default Table8 initial value', () => {
        const formGroup = service.createTable8FormGroup(sampleWithNewData);

        const table8 = service.getTable8(formGroup) as any;

        expect(table8).toMatchObject(sampleWithNewData);
      });

      it('should return NewTable8 for empty Table8 initial value', () => {
        const formGroup = service.createTable8FormGroup();

        const table8 = service.getTable8(formGroup) as any;

        expect(table8).toMatchObject({});
      });

      it('should return ITable8', () => {
        const formGroup = service.createTable8FormGroup(sampleWithRequiredData);

        const table8 = service.getTable8(formGroup) as any;

        expect(table8).toMatchObject(sampleWithRequiredData);
      });
    });

    describe('resetForm', () => {
      it('passing ITable8 should not enable id FormControl', () => {
        const formGroup = service.createTable8FormGroup();
      ...
      it('passing NewTable8 should disable id FormControl', () => {
        const formGroup = service.createTable8FormGroup(sampleWithRequiredData);
        expect(formGroup.controls.id.disabled).toBe(true);
