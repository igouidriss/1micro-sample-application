...
import { sampleWithRequiredData, sampleWithNewData } from '../table-7.test-samples';

import { Table7FormService } from './table-7-form.service';

describe('Table7 Form Service', () => {
  let service: Table7FormService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(Table7FormService);
  });

  describe('Service methods', () => {
    describe('createTable7FormGroup', () => {
      it('should create a new form with FormControl', () => {
        const formGroup = service.createTable7FormGroup();
      ...
      it('passing ITable7 should create a new form with FormGroup', () => {
        const formGroup = service.createTable7FormGroup(sampleWithRequiredData);
    ...
    describe('getTable7', () => {
      it('should return NewTable7 for default Table7 initial value', () => {
        const formGroup = service.createTable7FormGroup(sampleWithNewData);

        const table7 = service.getTable7(formGroup) as any;

        expect(table7).toMatchObject(sampleWithNewData);
      });

      it('should return NewTable7 for empty Table7 initial value', () => {
        const formGroup = service.createTable7FormGroup();

        const table7 = service.getTable7(formGroup) as any;

        expect(table7).toMatchObject({});
      });

      it('should return ITable7', () => {
        const formGroup = service.createTable7FormGroup(sampleWithRequiredData);

        const table7 = service.getTable7(formGroup) as any;

        expect(table7).toMatchObject(sampleWithRequiredData);
      });
    });

    describe('resetForm', () => {
      it('passing ITable7 should not enable id FormControl', () => {
        const formGroup = service.createTable7FormGroup();
      ...
      it('passing NewTable7 should disable id FormControl', () => {
        const formGroup = service.createTable7FormGroup(sampleWithRequiredData);
        expect(formGroup.controls.id.disabled).toBe(true);
