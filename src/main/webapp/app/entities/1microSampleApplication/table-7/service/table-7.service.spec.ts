...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../table-7.test-samples';

import { Table7Service, RestTable7 } from './table-7.service';

const requireRestSample: RestTable7 = {
...
describe('Table7 Service', () => {
  ...
  let expectedResult: ITable7 | ITable7[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    it('should create a Table7', () => {
      const table7 = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(table7).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Table7', () => {
      const table7 = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(table7).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should partial update a Table7', () => {
    ...
    it('should return a list of Table7', () => {
      const returnedFromService = { ...requireRestSample };
    ...
    describe('addTable7ToCollectionIfMissing', () => {
      it('should add a Table7 to an empty array', () => {
        const table7: ITable7 = sampleWithRequiredData;
        expectedResult = service.addTable7ToCollectionIfMissing([], table7);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table7);
      });

      it('should not add a Table7 to an array that contains it', () => {
        const table7: ITable7 = sampleWithRequiredData;
        const table7Collection: ITable7[] = [
          {
            ...table7,
          },
          sampleWithPartialData,
        ];
        expectedResult = service.addTable7ToCollectionIfMissing(table7Collection, table7);
        expect(expectedResult).toHaveLength(2);
      });

      it("should add a Table7 to an array that doesn't contain it", () => {
        const table7: ITable7 = sampleWithRequiredData;
        const table7Collection: ITable7[] = [sampleWithPartialData];
        expectedResult = service.addTable7ToCollectionIfMissing(table7Collection, table7);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table7);
      });

      it('should add only unique Table7 to an array', () => {
        const table7Array: ITable7[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const table7Collection: ITable7[] = [sampleWithRequiredData];
        expectedResult = service.addTable7ToCollectionIfMissing(table7Collection, ...table7Array);
        expect(expectedResult).toHaveLength(3);
      });

      it('should accept varargs', () => {
        const table7: ITable7 = sampleWithRequiredData;
        const table72: ITable7 = sampleWithPartialData;
        expectedResult = service.addTable7ToCollectionIfMissing([], table7, table72);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table7);
        expect(expectedResult).toContain(table72);
      });

      it('should accept null and undefined values', () => {
        const table7: ITable7 = sampleWithRequiredData;
        expectedResult = service.addTable7ToCollectionIfMissing([], null, table7, undefined);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table7);
      });

      it('should return initial array if no Table7 is added', () => {
        const table7Collection: ITable7[] = [sampleWithRequiredData];
        expectedResult = service.addTable7ToCollectionIfMissing(table7Collection, undefined, null);
        expect(expectedResult).toEqual(table7Collection);
      });
    });

    describe('compareTable7', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareTable7(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareTable7(entity1, entity2);
        const compareResult2 = service.compareTable7(entity2, entity1);
