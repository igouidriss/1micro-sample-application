...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../table-9.test-samples';

import { Table9Service, RestTable9 } from './table-9.service';

const requireRestSample: RestTable9 = {
...
describe('Table9 Service', () => {
  ...
  let expectedResult: ITable9 | ITable9[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    it('should create a Table9', () => {
      const table9 = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(table9).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Table9', () => {
      const table9 = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(table9).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should partial update a Table9', () => {
    ...
    it('should return a list of Table9', () => {
      const returnedFromService = { ...requireRestSample };
    ...
    describe('addTable9ToCollectionIfMissing', () => {
      it('should add a Table9 to an empty array', () => {
        const table9: ITable9 = sampleWithRequiredData;
        expectedResult = service.addTable9ToCollectionIfMissing([], table9);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table9);
      });

      it('should not add a Table9 to an array that contains it', () => {
        const table9: ITable9 = sampleWithRequiredData;
        const table9Collection: ITable9[] = [
          {
            ...table9,
          },
          sampleWithPartialData,
        ];
        expectedResult = service.addTable9ToCollectionIfMissing(table9Collection, table9);
        expect(expectedResult).toHaveLength(2);
      });

      it("should add a Table9 to an array that doesn't contain it", () => {
        const table9: ITable9 = sampleWithRequiredData;
        const table9Collection: ITable9[] = [sampleWithPartialData];
        expectedResult = service.addTable9ToCollectionIfMissing(table9Collection, table9);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table9);
      });

      it('should add only unique Table9 to an array', () => {
        const table9Array: ITable9[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const table9Collection: ITable9[] = [sampleWithRequiredData];
        expectedResult = service.addTable9ToCollectionIfMissing(table9Collection, ...table9Array);
        expect(expectedResult).toHaveLength(3);
      });

      it('should accept varargs', () => {
        const table9: ITable9 = sampleWithRequiredData;
        const table92: ITable9 = sampleWithPartialData;
        expectedResult = service.addTable9ToCollectionIfMissing([], table9, table92);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table9);
        expect(expectedResult).toContain(table92);
      });

      it('should accept null and undefined values', () => {
        const table9: ITable9 = sampleWithRequiredData;
        expectedResult = service.addTable9ToCollectionIfMissing([], null, table9, undefined);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table9);
      });

      it('should return initial array if no Table9 is added', () => {
        const table9Collection: ITable9[] = [sampleWithRequiredData];
        expectedResult = service.addTable9ToCollectionIfMissing(table9Collection, undefined, null);
        expect(expectedResult).toEqual(table9Collection);
      });
    });

    describe('compareTable9', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareTable9(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareTable9(entity1, entity2);
        const compareResult2 = service.compareTable9(entity2, entity1);
