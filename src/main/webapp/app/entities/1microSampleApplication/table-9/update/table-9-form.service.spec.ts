...
import { sampleWithRequiredData, sampleWithNewData } from '../table-9.test-samples';

import { Table9FormService } from './table-9-form.service';

describe('Table9 Form Service', () => {
  let service: Table9FormService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(Table9FormService);
  });

  describe('Service methods', () => {
    describe('createTable9FormGroup', () => {
      it('should create a new form with FormControl', () => {
        const formGroup = service.createTable9FormGroup();
      ...
      it('passing ITable9 should create a new form with FormGroup', () => {
        const formGroup = service.createTable9FormGroup(sampleWithRequiredData);
    ...
    describe('getTable9', () => {
      it('should return NewTable9 for default Table9 initial value', () => {
        const formGroup = service.createTable9FormGroup(sampleWithNewData);

        const table9 = service.getTable9(formGroup) as any;

        expect(table9).toMatchObject(sampleWithNewData);
      });

      it('should return NewTable9 for empty Table9 initial value', () => {
        const formGroup = service.createTable9FormGroup();

        const table9 = service.getTable9(formGroup) as any;

        expect(table9).toMatchObject({});
      });

      it('should return ITable9', () => {
        const formGroup = service.createTable9FormGroup(sampleWithRequiredData);

        const table9 = service.getTable9(formGroup) as any;

        expect(table9).toMatchObject(sampleWithRequiredData);
      });
    });

    describe('resetForm', () => {
      it('passing ITable9 should not enable id FormControl', () => {
        const formGroup = service.createTable9FormGroup();
      ...
      it('passing NewTable9 should disable id FormControl', () => {
        const formGroup = service.createTable9FormGroup(sampleWithRequiredData);
        expect(formGroup.controls.id.disabled).toBe(true);
